                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <input type="date" v-model="form.sale_date" name="sale_date" id="sale_date" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-r-md sm:text-sm border-gray-300" placeholder="Select purchase date">
                            </div>
                        </div>
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <!-- </div> -->
                                <input type="number" v-model="form.price" name="price" id="price" step="0.01" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full sm:text-sm border-gray-300" placeholder="0.00">
...
<script>
  ...
  export default {
    ...
    methods: {
        createPurchase() {
            this.$inertia.post('/sales', this.form)
            .then(() => {
                //code
            })
        }
